defmodule SCOS.OrganizationMessageTest do
  use ExUnit.Case
  ...
  describe "new" do
    test "create new organization message via map with string keys", %{string_key_message: string_key_message} do
      {:ok, actual} = OrganizationMessage.new(string_key_message)
